...
from data_hub.transforms import get_noise_transform,noise_from_cfg,rescale_imgs
...
class IPhoneSummer2023():
    ...
    def __getitem__(self, index):
        ...
        # -- re-scale imgs --
        clean,fflow,bflow = rescale_imgs(self.iscale,clean,fflow,bflow)
        fflow *= self.iscale
        bflow *= self.iscale
...
def get_iphone_sum2023_dataset(cfg):
    return load(cfg)
