...
def load(cfg):
    ...
    # -- create objcs --
    data = edict()
    data.tr = Toy(iroot,sroot,"train",noise_info,nsamples.tr,nframes.tr,isize.tr)
    data.val = Toy(iroot,sroot,"val",noise_info,nsamples.val,nframes.val,isize.val)
    data.te = Toy(iroot,sroot,"test",noise_info,nsamples.te,nframes.te,isize.te)
